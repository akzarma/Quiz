 ...
 * @author Akshay
 */
public class DispStudent extends javax.swing.JFrame {

    /**
     * Creates new form DispStudent
     */
    public DispStudent() {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Username", "Password", "College", "Classs", "Score", "Given?"
            }
        ) {
        ...
        jButton1.setText("Get Student List");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DispStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DispStudent().setVisible(true);
            }
        });
    }
